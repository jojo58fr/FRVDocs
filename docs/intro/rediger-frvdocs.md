---
title: Comment rédiger pour FRVDocs ? (les outils..etc)
...
``` md
![Texte alternatif](https://url-de-l-image)
```
...
![Channel où poster le guide pour FRVDocs](./img/channels-poster-markdown.png)
...
![Exemple rédaction article](./img/exemple-redaction-article.png)
