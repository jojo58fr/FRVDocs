...
### Version vidéo
**(non-officiel à FRVDocs, vidéo recommandée à la communauté)**
<div style={{ width: '100%', maxWidth: '100%', marginTop: '1rem', marginBottom: '1rem' }}>
  <div
    ...
    <iframe
      src="https://www.youtube.com/embed/gA5IlmCGI9k"
...
- les outils,
- les sanctions,
- les bonnes pratiques Discord,
- une bibliographie de ressources fiables.

---

# 📜 Principes Généraux de Modération
...
## 🔁 Spam
Tout comportement répétitif ou perturbateur doit être encadré.

1. Prévenir et expliquer brièvement les règles.  
2. Si répétition → sanctions progressives.

**Sanction : Time-out court → Time-out plus long → Bannissement**

---

## 😡 Respect & Attitude
Tout propos dénigrant, agressif ou visant à faire pression sur la communauté doit être sanctionné.
...
Une liste complète des commandes modérateurs est disponible ici :  
https://www.streamscheme.com/twitch-moderator-chat-commands/
...
- spam ou flood,
- messages hors-sujet dans les salons dédiés.
...
- **Ganknow Learn** – *VTuber Etiquette: Community Management and Online Harassment*  
  https://learn.ganknow.com/course/vtuber-etiquette/
...
**Membres d'FRVtubers ayant contribué:**
- [Elvyraptor](https://www.twitch.tv/elvyraptor)
